...
function Notification:drawKill(systemName,regionName,secStatus)
    ...
    pushStyle()
    fill(222, 10, 10, 255)
    text(victimAllianceName, 210,20)
    popStyle()
    ...
    pushStyle()
    fill(66, 255, 0, 255)
    text(FBAllianceName, WIDTH-280,20)
    popStyle()
    ...
    textMode(CORNER)
    textAlign(LEFT)
    text("Pilots Involved: ", WIDTH-350,1)
    pushStyle()
    fill(66, 255, 0, 255)
    text(involvedPartyCount, WIDTH-235,1)
    popStyle()
